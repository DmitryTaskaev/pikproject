...
const modalTitle = useState('experienceCardModalTitle', () => 'Инновации')
const modalText = useState(
	'experienceCardModalText',
	() =>
...
<template>
	<Modal
		...
		mode="center"
	>
		<div class="experience-card-modal__container">
			<div class="experience-card-modal__top">
				<Text
			...
			<div class="experience-card-modal__content">
				<Text
